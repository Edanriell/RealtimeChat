		...
		>
			...
			<div className={"flex-1 max-h-full overflow-y-scroll w-full"}>
				<div className={"flex flex-col flex-auto h-full p-6"}>
					<div
						className={
							"flex flex-col flex-auto flex-shrink-0 rounded-2xl " +
							"bg-gray-50 h-full p-4"
						}
					>
								...
								<div className={"grid grid-cols-12 gap-y-2"}>
									<div className={"col-start-6 col-end-13 p-3 rounded-lg"}>
										...
										>
											...
											<div
												className={
													"relative mr-3 text-sm bg-indigo-100 text-black " +
													"py-2 px-4 border border-gray-100 rounded-xl"
												}
											>
									...
									<div className={"col-start-1 col-end-8 p-3 rounded-lg"}>
										<div className={"flex flex-row items-center"}>
											...
											<div
												className={
													"relative ml-3 text-sm bg-white py-2 px-4 " +
